...
urlpatterns = [
    ...
    path('report-box-delete/<int:pk>', ReportDeleteView.as_view(), name='report_box_delete'),
    path('report-client-delete/<int:pk>', DeleteReportFactureView.as_view(), name='report_client_delete'),
